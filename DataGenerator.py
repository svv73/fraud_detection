...
def generate_customer_profiles_table(n_customers, random_state=0):
    ...
    for customer_id in range(n_customers):
        ...
        mean_amount = np.random.uniform(100, 2000)  # Arbitrary (but sensible) value
...
def generate_transactions_table(customer_profile, start_date="2021-07-01", nb_days=10):
...
def generate_dataset(n_customers=10000, n_terminals=1000000, nb_days=90, start_date="2021-07-01", r=5):
...
def add_frauds(customer_profiles_table, terminal_profiles_table, transactions_df):
    ...
    # Scenario 1
    transactions_df.loc[transactions_df.TX_AMOUNT > 4400, 'TX_FRAUD'] = 1
    transactions_df.loc[transactions_df.TX_AMOUNT > 4400, 'TX_FRAUD_SCENARIO'] = 1
...
if __name__ == "__main__":
    ...
    transactions_df.to_csv(DIR_OUTPUT + "trs.csv")